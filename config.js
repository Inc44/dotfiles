[
	// Psi, chi, mu, phi, pi, psi, rho, tau are already included in GREEK
	// ell, mid, iff, forall, approx, perp, angle, cong, div, max, min, neg and wedge are already included in SYMBOLS

	// land, lnot and lor are the same as wedge, neg and vee
	...
	// Use rm for the rest of the trigonometric functions:
	// arccot, arccsc, arcsec
	// arsinh, arcosh, artanh, arcoth, arcsch, csch, arcsech, sech

	// Symbols
	{trigger: "yes", replacement: "✔️", options: ""},
	{trigger: "no", replacement: "❌", options: ""},
	{trigger: "cuz", replacement: "\\because", options: "mA"},
	{trigger: "thus", replacement: "\\therefore", options: "mA"},
	{trigger: "bps", replacement: "\\blacksquare", options: "mA"},
	{trigger: "eps", replacement: "\\square", options: "mA"},
	{trigger: "trigon", replacement: "\\triangle", options: "mA"},
	{trigger: "deg", replacement: "^{\\circ}", options: "mA"},

	// Operators
	{trigger: "bin", replacement: "️\\binom{$0}{$1}$2", options: "mA"},
	{trigger: "??", replacement: "{ $0 \\over $1 }$2", options: "mA"},
	{trigger: "comp", replacement: "\\circ", options: "mA"},
	{trigger: "nots", replacement: "\\not", options: "mA"},
	{trigger: "sans", replacement: "\\setminus", options: "mA"},
	{trigger: "vedge", replacement: "\\vee", options: "mA"},
	...
	{trigger: "ovs", replacement: "️\\overset{$0}{$1}$2", options: "mA"},
	{trigger: "uns", replacement: "️\\underset{$0}{$1}$2", options: "mA"},

	// Dots
	{trigger: /([^\\])(vdot|odot|ddot|cdot|dot)/, replacement: "[[0]]\\[[1]]", options: "rmA"},

	// Transform
	{trigger: "la", replacement: "\\mathscr{L}\\{ $0 \\}$1", options: "mA"},

	// nth Square Root
	{trigger: "nsq", replacement: "\\sqrt[$0]{ $1 }$2", options: "mA"},

	// Trends
	{trigger: "incr", replacement: "\\uparrow", options: "mA"},
	{trigger: "decr", replacement: "\\downarrow", options: "mA"},

	// Environment
    {trigger: "orc", replacement: "️\\left[\\begin{aligned}\n$0\n\\end{aligned}\\right.", options: "mA"},
	...
	{trigger: "([a-be-np-uw-zA-Z])dot", replacement: "\\dot{[[0]]}", options: "rmA", priority: 1},
