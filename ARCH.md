...
```
yay -S betterlockscreen czkawka-gui-bin microsoft-edge-stable-bin nvidia-container-toolkit oculante peazip-qt-bin qview rclone-browser visual-studio-code-bin xdman-beta-bin xwinwrap-0.9-bin yandex-browser
```
