...
if type apt > /dev/null 2>&1; then
    ...
    clean="sudo rm -rf /var/cache/pacman/pkg/download-*; sudo pacman -Sc; sudo pacman -Scc; sudo paccache -ruk0; yay -Sc; flatpak uninstall --unused"
fi
...
export PATH="/home/pc/.pyenv/bin:$PATH"
