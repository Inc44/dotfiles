...
if type apt > /dev/null 2>&1; then
    ...
    clean="sudo pacman -Sc; sudo pacman -Scc; sudo paccache -ruk0; yay -Sc; flatpak uninstall --unused"
fi
...
alias g="ced; sudo python3 -OO /boot/grub2/themes/minegrub/update_theme.py '' 'I use Arch BTW!'"
